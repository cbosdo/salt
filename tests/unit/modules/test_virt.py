  ...
  <guest>
    ...
    def test_update(self):
        ...
        self.assertEqual(
            ...
            virt.update("my_vm", boot=uefi_boot),
        )
        setxml = ET.fromstring(define_mock.call_args[0][0])
        self.assertEqual(
        ...
        setxml = ET.fromstring(define_mock.call_args[0][0])
        self.assertEqual(
            setxml.find("memtune").find("soft_limit").text, str(int(0.5 * 1024 ** 2))
        )
        self.assertEqual(
            setxml.find("memtune").find("hard_limit").text, str(1024 * 1024)
        )
        self.assertEqual(
            setxml.find("memtune").find("swap_hard_limit").text, str(2048 * 1024)
        )
        self.assertEqual(
            setxml.find("memtune").find("min_guarantee").text, str(1 * 1024 ** 2)
        )
        ...
        setxml = ET.fromstring(define_mock.call_args[0][0])
        self.assertEqual(setxml.find("memory").get("unit"), "KiB")
        self.assertEqual(setxml.find("memory").text, str(int(0.5 * 1024 ** 2)))
        self.assertEqual(setxml.find("maxMemory").text, str(1 * 1024 ** 2))
        self.assertEqual(setxml.find("currentMemory").text, str(2 * 1024 ** 2))
        ...
        setxml = ET.fromstring(define_mock.call_args[0][0])
        self.assertEqual(setxml.find("maxMemory").text, str(3096 * 1024))
    ...
    def test_update_memtune_params(self):
        ...
        self.assertEqual(
            setxml.find("memtune").find("min_guarantee").attrib.get("unit"), "KiB"
        )
        self.assertEqual(setxml.find("maxMemory").text, str(3096 * 1024))
        self.assertEqual(setxml.find("maxMemory").attrib.get("slots"), "10")
        self.assertEqual(setxml.find("currentMemory").text, str(int(2.5 * 1024 ** 2)))
        self.assertEqual(setxml.find("memory").text, str(int(0.7 * 1024 ** 2)))
